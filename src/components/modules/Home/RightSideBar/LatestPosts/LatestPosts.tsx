							...
							(post) =>
								post.status && (
									<div key={post._id} className="relative">
										...
										<div
											className={`${post.isPremium && user?.status === 'basic' ? 'absolute' : post.isPremium ? 'absolute' : 'hidden'} inset-0 bg-black bg-opacity-10 backdrop-blur-md z-50 flex items-center justify-center rounded-md`}
										>
