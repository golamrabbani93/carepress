		...
		<div className="flex items-start mb-4 w-full">
			...
			<div className="">
				<div className="flex items-center justify-center">
					<div className="border border-gray-300 p-2 rounded-lg w-fit sm:w-[300px] ]">
						<div className="flex justify-between">
							<h3 className="text-sm sm:text-base font-semibold">{comment.author.name}</h3>
							<span className="text-[10px] sm:text-[12px] text-gray-500 ml-2">
